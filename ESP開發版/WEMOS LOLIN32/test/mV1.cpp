...
U8G2_SSD1306_128X64_NONAME_1_SW_I2C u8g2(U8G2_R0, /* clock=*/ 4, /* data=*/ 5, /* reset=*/ U8X8_PIN_NONE);   // All Boards without Reset of the Display
...
// 網 路 相 關 參 數
//╚═════════════════╝
const char globleWiFiSSID[] = "LouisaCoffee"; //威秀wifi
const char globleWiFiPassword[] = "26265613"; //12346789
